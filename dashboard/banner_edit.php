...
$edit_id = get('edit_id');
$select = q("SELECT * FROM `banner` WHERE `banner_id`='$edit_id'");
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            ...
            <form action="banner_update.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="hidden" name="banner_id" value="<?php echo $assoc['banner_id'];?>">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <img id="blah" width= 50px src="../assets/images/banner/<?php echo $assoc['img'];?>" alt="">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
              ...
              <div class="form-layout-footer mg-t-30 text-center">
                <button type="submit" class="btn btn-info mg-r-5" style="cursor: pointer;">Update Banner</button>
