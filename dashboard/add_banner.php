...
if ($_SERVER['REQUEST_METHOD']== "POST") {
  ...
  if (in_array($ext, $allow_file)) {
    ...
    $new_location = '../assets/images/banner/'.$new_file_name;
    move_uploaded_file($uploaded_img['tmp_name'], $new_location);
    $insert = q("INSERT INTO `banner`(`img`, `summery`, `title`, `sub_title`) VALUES ('$new_file_name','$summery','$title','$sub_title')");
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Banner Preview Image<span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <img id="blah" width= 50px src="" alt="">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Banner summery: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="summery"  placeholder="Enter Summery">
                </div>
              </div>
              <div class="row mg-t-20">
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Banner Sub Title: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="sub_title" placeholder="Enter Sub Title">
                </div>
              </div>
              <div class="form-layout-footer mg-t-30 text-center">
                <button type="submit" class="btn btn-info mg-r-5" style="cursor: pointer;">Add Banner</button>
